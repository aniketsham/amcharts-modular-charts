...
const Home = () => {
  ...
  const updateMarketValue = (index: number, newValue: number) => {
    ...
    <div className='flex flex-row gap-5 justify-center items-center pb-10'>
        ...
        <input placeholder='market' className='border-2 border-black bg-white' value={marketValue[0]} onChange={(e)=>{updateMarketValue(0,Number(e.target.value))}} type="number">
        </input>
        </div>
        <div>
        <label className='pr-2 font-bold text-xl'>2</label>
        <input placeholder='2' className='border-2 border-black bg-white' value={marketValue[1]} onChange={(e)=>{updateMarketValue(1,Number(e.target.value))}}  type="number">
        </input>
        </div>
        <div>
        <label className='pr-2 font-bold text-xl'>3</label>
        <input placeholder='3' className='border-2 border-black bg-white' value={marketValue[2]}  onChange={(e)=>{updateMarketValue(2,Number(e.target.value))}}  type="number">
        </input>
        </div>
    </div>
